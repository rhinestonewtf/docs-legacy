	...
	return (
		<div className="grid gap-y-8 content-start">
			<div className="grid gap-y-3">
				<h1 className="mb-0 text-[28px] text-gray-900">Page not found</h1>
				<p className="my-0 max-w-md text-base text-gray-900">
					We can&apos;t find the page you&apos;re looking for. Select a page from the menu to continue
					exploring the docs.
				</p>
			</div>
