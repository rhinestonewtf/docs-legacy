...
### Why are we proposing that the [Registry] is a singleton that others build on top of instead of spinning up their own registry?
...
### How is the on-going development of the [Registry] managed?

The [Registry] is a public good for the Ethereum ecosystem. Built with the intention of benefiting all AA builders across both the infra and application layer. Therefore, the intention is for the [Registry] to be ownerless and community operated from the outset.

The [Registry] is currently under development and will be launched as a singleton. We welcome any feedback and invite all teams to assist with the development of V1.
