...
[ERC-6900](https://eips.ethereum.org/EIPS/eip-6900) is an attempt to standardize modular smart accounts. In particular, module interfaces and how different module functions are called. In a world where ERC-6900 is finalised and fully adopted, we will still require a solution for module security to ensure that if a user installs a module built by a third-party developer they are able to gain assurances (without needing to inspect the code) that the module is not malicious.
