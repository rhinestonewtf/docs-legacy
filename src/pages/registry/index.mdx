...
The [Registry] is a crucial element in advancing Ethereum's account abstraction capabilities. Modular account abstraction provides a platform for open innovation within the wallet stack. However, it also introduces a number of new security concerns and attack vectors.
...
In order to prevent vendor-lock in and module fragmentation, the [Registry] is a public good that is open, permissionless and free to use and build on top of.

<Note title="FYI">
	The [Registry] is currenty in **alpha** and in active development. Do not use the contracts in production.
</Note>
