...
For more on ERC-4337 please refer to the [official proposal](https://eips.ethereum.org/EIPS/eip-4337) or check out our partners: {{ className: "mb-0" }}
...
There are three layers to account abstraction: {{ className: "mb-0" }}

-   Infrastructure for smart account execution [(ERC-4337)](https://eips.ethereum.org/EIPS/eip-4337)
-   Smart accounts and modules [(ERC-6900)](https://eips.ethereum.org/EIPS/eip-4337)
-   User interface for controlling a smart account (wallets)

## Motivation for account abstraction

We can’t say it better than Vitalik himself – [The Three Transitions](https://vitalik.ca/general/2023/06/09/three_transitions.html)
