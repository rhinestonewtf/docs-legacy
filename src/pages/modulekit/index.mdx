...
Rhinestone maintains a library of generalised module templates that can be used as a base layer for more complicated functions. This includes templates for basic validator and executor functions. A set of example modules can also be found in the[ modulekit-examples repo](https://github.com/rhinestonewtf/modulekit-examples). For a list of open-source modules and resources visit the [awesome-modular-accounts repo](https://github.com/rhinestonewtf/modulekit).
