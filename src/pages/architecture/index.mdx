...
<Note type="info">
Notable Mentions: The Registry is taking inspiration of [EAS](https://attest.sh) while unique registration logic for modular account abstraction and L2 propagation. 
</Note>

<Fence className="bg-gray-100" >
![Attestation Flow](/images/docs/introduction/complete-flow.svg)
</Fence>
