...
<Note type="info">
	Notable Mentions: The Registry takes inspiration from [EAS](https://attest.sh) but extends it with unique
	registration logic specifically built for modular account abstraction and L2 propagation.
</Note>
