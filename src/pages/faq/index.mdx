...
### Why is the [Rhinestone Registry] needed?

The [Rhinestone Registry] allows modular smart accounts to tap into a marketplace of third-party modules. The problem that the registry solves is that allowing users to install arbitrary third-party modules into their smart accounts presents a huge security risk, very likely leading to accounts being compromised and funds being lost.
...
### How is the [Rhinestone Registry] different to the Ethereum Attestation Service?
