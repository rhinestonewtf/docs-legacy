...
If you are an application developer and want to use modules in your application, you can use the Module Store to find and install modules. The Module Store, together with our Application SDK, will allow you to easily integrate modules into your application. To learn more about the SDK, check out the [SDK documentation](../sdk/) (coming soon).
