...
The ModuleKit has a helper to easily deploy modules and register them on the [Module Registry](/module-registry). This will allow easy discoverability and useage of your module.
