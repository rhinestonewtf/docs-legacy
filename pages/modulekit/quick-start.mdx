...
The quickest way to get started with building a smart account module. This quickstart guide will walk you through building a simple validator module. To learn more about validators, check out the [modules](/modulekit/modules) section of the docs. To learn more about the ModuleKit tools that you will be using during this guide, check out the [tools](/modulekit/tools) section of the docs.
