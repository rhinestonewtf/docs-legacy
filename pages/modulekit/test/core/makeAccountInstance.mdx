...
The address of the default validator to use for the account. This needs to be couples with an account helper that knows how to format the signature for this validator.
