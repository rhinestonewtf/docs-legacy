...
The ModuleKit is integrated with the [ERC-4337 Validation library](/erc4337-validation) in order to make it effortless to ensure modules comply with the restrictions required by the ERC-4337 mempool. You can find the restrictions in the [ERC-7562 specifications](https://eips.ethereum.org/EIPS/eip-7562).
