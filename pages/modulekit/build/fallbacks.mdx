...
This page only aims to cover domain 2 in the specific case of a Fallback Module. For more information on the other two, read through the [Module](./module.mdx) page.
...
In order to build a compliant fallback module you need to ensure that it:
