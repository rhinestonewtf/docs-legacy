...
This page aims to cover domains 1 and 3, since these are the same across different module types. For more information on domain 2, read through the specific module type pages.

## Building a module

In order to build a compliant module you need to ensure that it:
