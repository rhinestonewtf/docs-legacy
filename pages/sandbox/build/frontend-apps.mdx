...
The Sandbox comes with a set of pre-built [UI components](https://github.com/rhinestonewtf/sandbox/tree/main/src/ui-kit) that developers can leverage. These components are designed to be re-usable and can be used to build your frontend applications.
