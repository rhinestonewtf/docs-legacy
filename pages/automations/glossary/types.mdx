...
- Type: [`Action[]`](/automations/glossary/types.mdx#action)
...
- Type: [`EventBasedTrigger`](/automations/glossary/types.mdx#eventbasedtrigger)
...
- Type: [`TimeBasedTrigger`](/automations/glossary/types.mdx#timebasedtrigger)
