...
Create Automation client to interact with the automation service.
...
Account init code in case account is not deployed yet.

### network
- Type: `number`

Chain id of the network. currently only sepolia network is supported.
