...
The Automations SDK is built on top of [viem](https://viem.sh/), a typesafe, modern Ethereum library. Apart from that, the SDK is standalone and can be used without any other dependencies and in any javascript or typescript project.
