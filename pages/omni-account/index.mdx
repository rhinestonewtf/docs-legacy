...
- [**Omni Account](/omni-account/architecture/omni-account) Modules:** A set of ERC-7579 modules that enforce resource locks and set verifiable execution pathways for the Orchestrator to the integrated Settlement Layers.
