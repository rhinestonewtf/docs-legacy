...
For a complete tutorial to create a new Omni Account, see [tutorial 1](/omni-account/tutorial-1) and for a tutorial on using an existing Omni Account, see [tutorial 2](/omni-account/tutorial-2).
