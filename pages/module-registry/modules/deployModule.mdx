...
The salt value to use for the module deployment. Note that the last 20 bytes should be either the `msg.sender` for replay protection or zeroed out.

### resolverUID

- Type: `ResolverUID | bytes32`

The resolver UID to use for the module deployment. You can find the default resolver UID in the [address book](/overview/address-book).
