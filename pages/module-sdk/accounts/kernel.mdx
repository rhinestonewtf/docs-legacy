...
The Kernel v3 is ERC-7579 compliant and can be used with the ModuleSDK. To create an account instance, use the `getAccount` function and then you can use the other functions below to get the calldata for module configuration actions on the account.
