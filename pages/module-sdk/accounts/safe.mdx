...
The Safe is ERC-7579 compliant through the [Safe7579](https://github.com/rhinestonewtf/safe7579) adapter and can be used with the ModuleSDK. To create an account instance, use the `getAccount` function and then you can use the other functions below to get the calldata for module configuration actions on the account.
