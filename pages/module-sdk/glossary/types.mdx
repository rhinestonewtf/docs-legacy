...
The object representing a ERC7739Data in a session.
...
The object representing a ActionData in a session.
...
The init data for installing validator.
...
- Type: [`SessionEIP712`](/module-sdk/glossary/types#sessioneip712)
...
- Type: [`EnableSession`](/module-sdk/glossary/types#enablesession)
...
- Type: [`ParamRules`](/module-sdk/glossary/types#paramrules)
...
- Type: [`ParamRule[]`](/module-sdk/glossary/types#paramrule)
...
- Type: [`ParamCondition`](/module-sdk/glossary/types#paramcondition)
...
- Type: [`LimitUsage`](/module-sdk/glossary/types#limitusage)
