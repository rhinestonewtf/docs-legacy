...
The target signature hooks to be installed. They get called on every function call with the specified signature being called on the target of the execution.
