...
The `getInstallWebAuthnValidator` function is used to create an instance of the WebAuthn Validator module. This function returns a module object.
...
```typescript
import { getInstallWebAuthnValidator } from "@rhinestone/module-sdk";

const webAuthnValidator = getInstallWebAuthnValidator({
  pubKeyX: 123,
  pubKeyY: 456,
