...
Social Recovery Validator allows users to recover their account using a social recovery mechanism

You can find the source code for the module in the [Core Modules](https://github.com/rhinestonewtf/core-modules/tree/main/src/SocialRecovery) and the deployment address in the [address book](../../overview/address-book.mdx).

## `getInstallSocialRecoveryValidator`

The `getInstallSocialRecoveryValidator` function is used to install social recovery validator in the account. This function returns a module object.
