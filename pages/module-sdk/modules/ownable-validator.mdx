...
The Ownable Validator module is a module that allows you to add an ECDSA owners to an account. The owners can then be used to validate transactions and other executions on the account.
