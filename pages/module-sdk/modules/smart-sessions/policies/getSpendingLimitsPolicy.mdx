...
Get the spending limits policy to use when creating a new session. The spending limits policy can be used to ensure that only a certain amount of a token can be spent.
