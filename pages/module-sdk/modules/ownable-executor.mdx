...
The `getOwnableExecuter` function is used to create an instance of the Ownable Executor module. This function returns a module object.
...
```typescript
import { getOwnableExecuter } from "@rhinestone/module-sdk";

const ownableExecutor = getOwnableExecuter({
  owner: "0x..",
});
```
...
const removeOwnableExecutorOwnerAction =
...
const executeOnOwnedAccountActions =
  getExecuteBatchOnOwnedAccountAction(params);
```
