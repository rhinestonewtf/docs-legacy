...
The `Execution` type is a type that represents an execution that is executed on the account. It has the following properties:

- `target`: The address of the target
- `value`: The native token value of the execution
- `callData`: The calldata of the execution to be executed on the target
