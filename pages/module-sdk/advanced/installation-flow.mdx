...
3. The data to install or uninstall is formatted into an array of `Action` objects. If the module is already installed when trying to install or not yet installed when trying to uninstall, the function will return an empty array.
